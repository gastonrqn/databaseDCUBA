\subsection{Creamos nuestra base de datos e ingresamos a ella:}

CREATE DATABASE DB\_GRUPO4\_TP1

USE DB\_GRUPO4\_TP1

\subsection{Creamos las tablas dentro de nuestra base de datos:}
